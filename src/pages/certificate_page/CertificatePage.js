...
import apsc from "../../images/apsc.pdf";
import wf from "../../images/wf.png";
import it from "../../images/it.png";
import yts from "../../images/yts.png";
import ot from "../../images/ot.pdf";
import yt from "../../images/yt.pdf";
import itc from "../../images/itc.pdf";
import its from "../../images/its.pdf"
import isp from "../../images/isp.pdf";
import is from "../../images/is.png";
import gu from "../../images/gu.png";
import ns from "../../images/ns.png";
import ac from "../../images/ac.pdf";
import acc from "../../images/acc.png";
import u from "../../images/u.pdf";
                            ...
                            <div className="cert-card">
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  Python FullStack Development : Under APSCHE
                                  Frontend & Backend.
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                            ...
                            <div className="cert-card">
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  Placement Preparation : Comprehensive
                                  Computer Course
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                            ...
                            <div className="cert-card">
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  HTML5, Python, and Flask Framework : For Implementing Web Applications
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                                  style={{
                            ...
                            <div className="cert-card">
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  Certified for WebinarFest organized by SORAX JMI and GDSC JMI
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                                  style={{
                            ...
                            <div className="cert-card">
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  Certified for Common Internship Test(CIT)
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                                  style={{
                        ...
                        <Col md={4} className="col-sm-12 col-md4">
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://www.linkedin.com/posts/surugowthamsai_css-javascript-js-activity-7107004757168308224-BbbI?utm_source=share&utm_medium=member_desktop&rcm=ACoAADyqJGQBHiTXmoHPCKu4Q8YAxvD0PXoybz0"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
                              ...
                              <div className="cert-body">
                                <h2
                                  ...
                                  style={{ fontWeight: 700, color: "#fbd9ad" }}
                                >
                                  Frontend Basics Certificate : HTML, CSS and JavaScript
                                  Fundamentals
                                </h2>
                                <h3
                                  className="cert-body-subtitle"
                        ...
                        <Col md={4} className="col-sm-12 col-md4">
                          <Fade bottom duration={2000} distance="20px">
                            <div className="cert-card">
                              <div className="content">
                                <a
                                  href="https://www.linkedin.com/posts/surugowthamsai_cisco-talentshine-pythonprogramming-activity-7093229311494664192-_JO8?utm_source=share&utm_medium=member_desktop&rcm=ACoAADyqJGQBHiTXmoHPCKu4Q8YAxvD0PXoybz0"
                                  target="_blank"
                                  rel="noopener noreferrer"
                                >
                                  <div className="content-overlay"></div>
